...
summary(model1)
#Null Deviance is 1154451 and Residual Deviance is 1154204.
...
summary(model2)
#Null Deviance is 8143.4 and Residual Deviance is 6345.1.
...
summary(model3)
#Null Deviance is 2917.9 and Residual Deviance is 2887.8.
